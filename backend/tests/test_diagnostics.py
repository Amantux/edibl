...
def test_diagnostics_leaks_no_secrets(auth_client, monkeypatch):
    monkeypatch.setenv("EDIBL_LLM_API_KEY", "sk-supersecret-value")
    monkeypatch.setenv("EDIBL_LLM_BASE_URL", "http://192.168.9.9:1234/v1")
    monkeypatch.setenv("EDIBL_DATABASE_URL", "postgresql://u:p@db/x")
